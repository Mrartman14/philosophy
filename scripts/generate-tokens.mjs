...
// theme-color (browser/PWA chrome) — точный sRGB-hex от surface-токена каждой темы.
// <meta name="theme-color"> не понимает CSS-var/oklch, поэтому конкретный hex; broad-support.
const themeColorTs = `/* AUTO-GENERATED by scripts/generate-tokens.mjs — DO NOT EDIT.
   Source: src/styles/tokens/primitives.ts (surface). Run \`pnpm generate:tokens\`. */

export const THEME_COLOR = {
  light: "${formatHex(colorLayers["light-normal"].surface)}",
  dark: "${formatHex(colorLayers["dark-normal"].surface)}",
} as const;
`;
writeFileSync(resolve(root, "src/styles/theme-color.generated.ts"), themeColorTs);
console.log("[generate-tokens] wrote src/styles/theme-color.generated.ts");
