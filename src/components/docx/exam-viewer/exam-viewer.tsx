  ...
  const [data, setData] = useState<ExamRule[]>([
    {
      ...
      answer:
        "Святая троица. Три грамматических лица. Гарри Поттер смотрит на карту мародёров, на которой видит себя, смотрящего на карту мародёров и тп.",
    },
    {
      ...
      answer:
        "На обеих картинках изображены три публичных образа бетмена — уязвимый Брюс Уэйн для близких, справедливый супергерой для жителей Готема и легкомысленный бизнесмен для прессы. На первой картинке туманом окутаны тела и видны только лица — юпостасисы, правильный ответ — каппадокийцы. На второй картинке в тумане два образа, как бы два проявления одного бога. Ответ — модализм.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Пузырь, как непознаваемая субстанция, удерживает первичные качества — число (шар с цифрой), движение (птица), форма (куб) и протяженность (зелёное вещество). Правильный ответ — Джон Локк.",
    },
    {
      title: "Отгадайте философа по картинке",
      order: 5,
      ...
      answer:
        "Пузырь, как протяженная субстанция, пропадает — остаются только качества и тот, кто их воспринимает, то есть мыслящая субстанция. Помимо первого воспринимаеющего появляется главный наблюдатель (человек в экране) — бог, в восприятии которого находится весь мир. Ответ — Джордж Беркли",
    },
    {
      title: "Отгадайте философа по картинке",
      order: 6,
      ...
      answer:
        "Дэвид Юм. Исчезает любая субстанция (Нео теперь тоже симуляция, главного наблюдателя нет), остаётся только воспринимающее и воспринимаемое.",
    },
    {
      title: "Отгадайте философа по картинке",
      order: 7,
    ...
    },
    {
      ...
      answer:
        "Марк Аврелий и усиление страстей из-заих прошлых и будущих переживаний.",
    },
    {
      title: "Отгадайте философа или его идею по картинке",
      order: 9,
      ...
      answer:
        "Джордж Беркли. Человек существует только в восприятии бога (в данном примере — терминатора).",
    },
    {
      ...
      answer:
        "Христианская эклесия и достижение сжатого времени. Первая картинка — человек стремится вести себя так, как будто он уже находится в будущем, к достижению которого он стремится (спираль времени ведущая к Граду Божьему). На второй картинке происходит разрыв времени — то, чего люди добиваются, приходя в церковь.",
    },
    {
      title: "Отгадайте философскую идею по картинке",
      order: 11,
      ...
      answer:
        "Краш-тест — философствующий человек разрушает картину реальности.",
    },
    {
      title: "Отгадайте философа по картинке",
      order: 12,
