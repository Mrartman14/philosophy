...
export const UpdatePrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-80 z-50 flex items-center justify-between gap-3 px-4 py-3 rounded-lg bg-(--color-text-pane) border border-(--color-border) shadow-lg">
