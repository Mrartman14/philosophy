...
const positionerClassName =
  // eslint-disable-next-line no-restricted-syntax -- RTL: data-[side=…]:right-[-10px]/left-[-10px] парятся с физическим data-side Base UI (RTL учтён DirectionProvider, см. Task 11)
...
const arrowClassName =
  // eslint-disable-next-line no-restricted-syntax -- RTL: data-[side=…]:right-[-13px]/left-[-13px] парятся с физическим data-side Base UI (RTL учтён DirectionProvider, см. Task 11)
