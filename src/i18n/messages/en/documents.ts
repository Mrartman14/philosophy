...
const documents = {
  ...
  merge: {
    ...
    badgeServerChanged: "changed in the saved version",
    badgeYourEdit: "your edit",
    badgeAddedByYou: "added by you",
    badgeAddedOnServer: "added in the saved version",
    badgeRemovedByYou: "removed by you",
    badgeRemovedOnServer: "removed in the saved version",
    conflictHeading: "Conflict — choose a block version",
    optionServer: "Saved version",
    ...
    cancelButton: "Cancel",
    takeServerButton: "Discard my edits, take the saved version",
    goneMessage:
