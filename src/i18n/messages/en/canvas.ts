...
const canvas: Messages["canvas"] = {
  ...
  editor: {
    ...
    toastCopiedTitle: "Copied to clipboard",
    toastCopyErrorTitle: "Couldn't copy",
  ...
  validate: {
    ...
    nodeNoId: "A node has no identifier",
    ...
    entityRefNoId: 'Reference "{id}" has no entity identifier',
    nodeUnknownType: 'Node "{id}": unknown type',
    edgeNoId: "An edge has no identifier",
    edgeFromNotFound: 'Edge "{id}": source node not found',
    edgeToNotFound: 'Edge "{id}": target node not found',
