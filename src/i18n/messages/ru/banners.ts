...
const banners = {
  ...
  fieldStartAt: "Начало показа (ваша таймзона)",
  fieldEndAt: "Окончание показа (ваша таймзона, необязательно)",
  fieldEventId: "ID события (необязательно)",
  fieldBlocks: "Текст баннера",
  eventIdPlaceholder: "ID события (см. Админ → События)",

  // --- Подсказки ---
  hintEndAt:
    "Уже сохранённое «Окончание показа» очистить нельзя — оставьте прежнее значение или укажите новое.",
