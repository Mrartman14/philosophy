...
const canvas = {
  ...
  validate: {
    ...
    nodeNoId: "У узла нет идентификатора",
    ...
    entityRefNoId: 'Ссылка "{id}" без идентификатора сущности',
    nodeUnknownType: 'Узел "{id}": неизвестный тип',
    edgeNoId: "У ребра нет идентификатора",
    edgeFromNotFound: 'Ребро "{id}": узел-источник не найден',
    edgeToNotFound: 'Ребро "{id}": узел-получатель не найден',
