...
const documents = {
  ...
  merge: {
    ...
    badgeServerChanged: "изменено в сохранённой версии",
    badgeYourEdit: "ваша правка",
    badgeAddedByYou: "добавлено вами",
    badgeAddedOnServer: "добавлено в сохранённой версии",
    badgeRemovedByYou: "удалено вами",
    badgeRemovedOnServer: "удалено в сохранённой версии",
    conflictHeading: "Конфликт — выберите версию блока",
    optionServer: "Сохранённая версия",
    optionMine: "Ваша версия",
    acceptDeletion: "Принять удаление",
    contentChanged: "содержимое изменено",
    unchangedLabel: "блоков без изменений",
    showUnchanged: "Показать блоки без изменений",
    hideUnchanged: "Скрыть блоки без изменений",
    applyButton: "Применить и продолжить",
    cancelButton: "Отмена",
    takeServerButton: "Отбросить мои правки, взять сохранённую",
    goneMessage:
