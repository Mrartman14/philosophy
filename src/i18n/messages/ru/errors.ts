...
const errors = {
  ...
  IDEMPOTENCY_KEY_INVALID:
    "Не удалось безопасно повторить запрос. Обновите страницу и повторите.",
  ...
  BLOCKS_INVALID: "Текст комментария содержит недопустимое форматирование.",
  ...
  INVALID_FORM_SCHEMA: "Структура формы не прошла проверку.",
  ...
  DOCUMENT_BLOCKS_INVALID: "Текст документа содержит недопустимое форматирование.",
  ...
  BANNER_INVALID_COLOR:
    "Неверный цвет фона: нужен hex вида #RGB или #RRGGBB.",
  BANNER_INVALID_DATE:
    "Неверные даты показа: проверьте формат и порядок начала и окончания.",
  BANNER_INVALID_EVENT: "Событие с таким id не найдено.",
  BANNER_BLOCKS_INVALID: "Текст баннера содержит недопустимое форматирование.",
  ...
  INVALID_DATE:
    "Неверная дата: проверьте формат и порядок дат начала и окончания.",
  INVALID_RRULE: "Не удалось распознать правило повторения. Проверьте настройку периодичности.",
  EVENT_BLOCKS_INVALID: "Описание события содержит недопустимое форматирование.",
  ...
  NOT_CONFIGURED: "Push-уведомления ещё не настроены.",
  ...
  ANNOTATION_BLOCKS_INVALID: "Текст аннотации содержит недопустимое форматирование.",
