...
const documents = {
  ...
  merge: {
    ...
    badgeServerChanged: "تم التغيير على الخادم",
    badgeYourEdit: "تعديلك",
    badgeAddedByYou: "أُضيف بواسطتك",
    badgeAddedOnServer: "أُضيف على الخادم",
    badgeRemovedByYou: "حُذف بواسطتك",
    badgeRemovedOnServer: "حُذف على الخادم",
    conflictHeading: "تعارض — اختر نسخة الكتلة",
    optionServer: "نسخة الخادم",
    optionMine: "نسختك",
    ...
    cancelButton: "إلغاء",
    takeServerButton: "تجاهل تعديلاتي وأخذ نسخة الخادم",
    goneMessage:
