  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Row label={t("motionFancy")}>
        <a href="/map" className="fancy-link w-fit rounded focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-ring)">{t("motionFancyText")}</a>
      </Row>
