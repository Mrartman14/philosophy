...
### Task B1: Lectures — optimistic locking (If-Match)
...
### Task B2: Trails — переход на документы + optimistic locking
...
### Task B4: «Выйти со всех устройств» (UI)
...
### Task B5: Гейт волны + финальное ревью
