...
- [ ] **Шаг 2: Проверить, что экспорты резолвятся**
...
- [ ] **Шаг 3: Реализовать render-map.ts**
...
- [ ] **Шаг 3: Реализовать geometry-editor.ts**
...
- [ ] **Шаг 1: Написать падающие тесты (init + selection + viewport + add)**
...
- [ ] **Шаг 3: Реализовать canvas-reducer.ts (полностью — включая команды Задачи 9, чтобы файл компилировался; тесты Задачи 9 добавим следом)**
...
- [ ] **Шаг 4: Запустить — убедиться, что зелёные (тесты части 1)**
...
- [ ] **Шаг 1: Дописать тесты (append в конец файла)**
...
- [ ] **Шаг 2: Запустить весь файл — убедиться, что всё зелёное**

Run: `npm test -- src/features/canvas/editor/canvas-reducer.test.ts`
Expected: PASS (все describe-блоки)

- [ ] **Шаг 3: Прогнать ВСЕ юниты ядра**
...
- [ ] **Шаг 2: Сверить TextInput (быстрая проверка)**
...
- [ ] **Шаг 2: Заменить require на статический импорт**
...
- [ ] **Шаг 3: Проверить компиляцию и линт**
...
- [ ] **Шаг 1: Экспортировать CanvasEditor из index слайса (append)**
...
- [ ] **Шаг 2: Создать страницу редактора**
...
- [ ] **Шаг 3: Заменить inline-форму на detail-странице кнопкой-ссылкой**
...
- [ ] **Шаг 4: Сверить импорты detail-страницы**
...
- [ ] **Шаг 1: Прогнать все юниты ядра**

Run: `npm test -- src/features/canvas/editor`
Expected: PASS (coords, render-map, validate, geometry-editor, canvas-reducer)

- [ ] **Шаг 2: Прогнать существующие тесты слайса/рендера (не сломали ли)**
...
- [ ] **Шаг 5: Ручной smoke (browser)** — выполняет ревьюер/пользователь, не агент
...
- [ ] **Шаг 6: Commit (если были мелкие фиксы по итогам)**
