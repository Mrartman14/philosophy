...
- [ ] **Step 1: Убедиться, что revision-history уже в ветке (зависимость от events)**
...
- [ ] **Step 2: Расширить types.ts (полное новое содержимое файла)**
...
- [ ] **Step 2: Добавить фетчеры в конец файла**
...
- [ ] **Step 1: `src/app/glossary/page.tsx` (полное новое содержимое)**
...
- [ ] **Step 2: `src/app/glossary/[id]/page.tsx` (полное новое содержимое)**
...
- [ ] **Step 2: Чеклист `src/features/_template/README.md` (применимые пункты для расширения слайса)**
...
- [ ] **Step 3: Ручной smoke (если поднят бек)**
...
- [ ] **Step 4: Если что-то правилось — финальный коммит**
