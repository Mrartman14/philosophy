...
- [ ] **Шаг 2: Проверить, что скопировалось**
...
- [ ] **Шаг 3: Реализовать permissions.ts**
...
- [ ] **Шаг 2: Написать падающие тесты geometry.test.ts**
...
- [ ] **Шаг 5: Запустить — убедиться, что зелёные**
...
- [ ] **Шаг 4: Написать тест canvas-render.test.tsx**
...
- [ ] **Шаг 1: Добавить тег CANVASES (append-only)**
...
- [ ] **Шаг 1: Записать public API (api + actions + permissions + types)**
...
- [ ] **Шаг 3: Реализовать entity-ref.ts**
...
- [ ] **Шаг 1: canvas-pagination.tsx** (копия паттерна MediaPagination — сохраняет `?q=`)
...
- [ ] **Шаг 3: canvas-my-list.tsx** (server)
...
- [ ] **Шаг 1: canvas-visibility-button.tsx**
...
- [ ] **Шаг 2: canvas-delete-button.tsx**
...
- [ ] **Шаг 3: canvas-detail.tsx** (server — мостик слайс → canvas-render)
...
- [ ] **Шаг 4: canvas-containers.tsx** (server)
...
- [ ] **Шаг 5: canvas-revisions.tsx** (server)
...
- [ ] **Шаг 1: Добавить UI-экспорты и entity-ref**
...
- [ ] **Шаг 4: Финальный self-review** (см. чеклист `src/features/_template/README.md`): server-only первой строкой в api/actions/permissions/schemas; каждая can* покрыта; каждая схема success+failure; createFormAction+parseFormData+requireCapability+revalidateEntity; нет импортов чужих `@/features/*`; нет `ui/.gitkeep`.

- [ ] **Шаг 5: Commit (если были правки от подстройки типов)**
