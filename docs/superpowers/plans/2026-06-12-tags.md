...
- [ ] **Step 3: Добавить кеш-тег в реестр (append-only!)**
...
- [ ] **Step 4: Проверить, что всё зелёное**
...
- [ ] **Step 3: tag-admin-row.tsx (inline-переименование)**
...
- [ ] **Step 4: Удалить .gitkeep, прогнать линт и тесты**
...
- [ ] **Step 1: types.ts — добавить LectureTag**
...
- [ ] **Step 2: lecture-card.tsx — бейджи тегов**
...
- [ ] **Step 3: lecture-detail.tsx — теги под заголовком**
...
- [ ] **Step 4: lecture-list.tsx — прокинуть карту тегов**
...
- [ ] **Step 1: lecture-search-form.tsx — Select по тегу**
...
- [ ] **Step 2: /lectures — фетч тегов для фильтра и карточек**
...
- [ ] **Step 3: /lectures/[id] — теги на странице лекции**
...
- [ ] **Step 4: Прогнать линт, тесты, сборку**
...
- [ ] **Step 2: Финальные гейты**

Run: `npm run lint && npm test && npm run build`
Expected: все три зелёные. Если красное — фиксить, не отключая правила.

- [ ] **Step 3: Верификация Parallel-safety contract**
