...
- [ ] **Step 1: Добавить ключ EVENTS (append-only, алфавитный порядок среди ключей)**
...
- [ ] **Step 4: Создать revision-history.tsx**
...
- [ ] **Step 2: event-delete-button.tsx** (паттерн `glossary-delete-button`)
...
- [ ] **Step 1: event-edit-form.tsx** (паттерн `glossary-edit-form`; blocks через hidden input; `entityContext="event"`)
...
- [ ] **Step 2: event-revisions.tsx** (async server component — мостик слайса к generic RevisionHistory)
...
- [ ] **Step 3: calendar-view.tsx** (server-safe, группировка по датам)
...
- [ ] **Step 3: [id]/export/route.ts (прокси .md/.txt)**
